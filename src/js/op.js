// import { OPERATIONS } from "./variables.js";
...
//       const opposite = -Number(this.currentNumber);
...
//       || (OPERATIONS.includes(element) && this.currentNumber.toString().includes(element !== '-'))
...
//     if (OPERATIONS.includes(element) && Number(this.result !== 0)) {
//       calculationScreenText.textContent = this.result + element;
//     }
...
//         if (OPERATIONS.includes(element) && i === 0
//           && !this.result
//           && this.prevNumber.toString().length > 1) {
//           return;
//         }

//         if (OPERATIONS.includes(element) && !isOperation) {
...
//           this.result = Number.isNaN(this.result) ? 0 : this.result;
...
//       if (this.result.toString().length > 6 && calculationScreenText.textContent.length < 17) {
//         calculationScreenResult.style.fontSize = `${60}px`;
//         calculationScreenResult.style.marginTop = `${41}px`;
//       }
//     }
...
//           if (OPERATIONS.includes(element) && i === 0 && !this.result) {
//             return;
//           }
